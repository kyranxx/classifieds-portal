...
export default function CreateAdPage() {
  ...
  return (
    <div className="container mx-auto p-4 max-w-3xl">
      <h1 className="text-4xl font-bold text-slate-800 mb-8 text-center">Post a New Ad</h1>
      <form onSubmit={handleSubmit} className="space-y-8 bg-white p-8 md:p-10 shadow-xl rounded-xl">
        ...
        <div>
          ...
          <input
            ...
            className="mt-1 block w-full px-4 py-3 border border-slate-300 rounded-lg shadow-sm focus:outline-none focus:ring-sky-500 focus:border-sky-500 sm:text-sm"
            required
        ...
        <div>
          <label htmlFor="lottieUrl" className="block text-sm font-medium text-slate-700 mb-1">
        ...
        <div>
          ...
          <input
            ...
            className="mt-1 block w-full text-sm text-slate-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-sky-50 file:text-sky-700 hover:file:bg-sky-100 cursor-pointer border border-slate-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-sky-500 focus:border-sky-500"
          />
          <p className="mt-1 text-xs text-slate-500">
            Images will be uploaded via Cloudflare.
          </p>
        </div>
        ...
        <div className="pt-2">
          <button
            type="submit"
            disabled={isLoading}
            className="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-base font-medium text-white bg-sky-600 hover:bg-sky-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-500 disabled:opacity-60 transition duration-150"
          >
